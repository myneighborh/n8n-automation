# n8n-automation
### An automated workflow that collects and summarizes news based on keywords from a Google Sheet using the Gemini model, and automatically emails the summarized results daily.
